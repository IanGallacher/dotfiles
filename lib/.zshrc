...
######################### CUSTOM ALIASES #################################
alias gctmp="git commit -m 'temp'"
alias glnames="git log --name-status --oneline"
alias gcano="git commit --amend --no-edit"
alias dps="docker ps"
alias vi="nvim"
de = f() { docker exec -it $1 /bin/bash }
den () { de $(docker inspect --format="{{.Id}}" $1 | cut -c1-12) }
